    ...
    <Dialog open={open} onClose={handleClose} className="relative z-10">
      ...
      <div className="fixed inset-0 z-10">
        <div className="flex h-screen w-screen items-center justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            <div className="w-full h-[15%] flex justify-between items-center text-[20px] border-b border-faded-blue">
              Settings
              <img
            ...
            <div className="border-b w-full h-[22.5%]">
              <button onClick={() => setDefaultColor("red")}>Red</button>
              <br />
              <button onClick={() => setDefaultColor("aqua")}>aqua</button>{" "}
              <br />
              <button onClick={() => setDefaultColor("lavender")}>
                laveender
              </button>
            </div>
            <div className="border-b w-full h-[22.5%]">
